...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Metro Admin Template - Metro  Style Bootstrap Admin Template</title>
...
<body>
					...
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							...
							<ul>
								...
								<li>
							<a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Sliders</a>
							<ul>
	...
	<!-- start: JavaScript-->
		...
		<script src="{{asset('backend/js/jquery.flot.j')}}s"></script>
		<script src="{{asset('backend/js/jquery.flot.pie.j')}}s"></script>
		...
		<script src="{{asset('backend/js/jquery.iphone.toggle.j')}}s"></script>
		...
		<script src="{{asset('backend/js/counter.j')}}s"></script>
