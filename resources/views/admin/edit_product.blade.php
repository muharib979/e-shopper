				...
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action="{{ url('/update-product',$all_product_info->product_id)}}" method="post" enctype="multipart/form-data">
						  ...
						  <fieldset>
							...
							<div class="control-group">
								...
								<div class="controls">
								  <select id="selectError3" name="category_id" value="{{$all_product_info->category_id}}">
                            ...
                            foreach ($all_published_category as $v_category) { ?> 
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <select id="selectError3" name="manufacture_id" value="{{$all_product_info->manufacture_id}}">
							...
							<div class="control-group hidden-phone">
							  ...
							  <div class="controls">
								<textarea class="cleditor" name="product_short_description" rows="3" >
									{{$all_product_info->product_short_description}}
								</textarea>
							  </div>
							</div>
							...
							<div class="control-group hidden-phone">
							  ...
							  <div class="controls">
								<textarea class="cleditor" name="product_long_description" rows="3" >
									{{$all_product_info->product_long_description}}
								</textarea>
							  </div>
							</div>
						...
						<div class="control-group">
							  ...
							  <div class="controls">
							  <td><img src="{{URL::to($all_product_info->product_image)}}" style="height: 80px;width: 80px;" ></td><br/>
								<input class="input-file uniform_on" name ="product_image" id="fileInput" type="file" value="{{$all_product_info->product_image}}" >
							  </div>
							</div>
